 ...
 */
public abstract class CommunicationChannelContributions extends UdoService<CommunicationChannelContributions> {

    public CommunicationChannelContributions() {
        super(CommunicationChannelContributions.class);
    }

    protected CommunicationChannelContributions(Class<? extends UdoService<CommunicationChannelContributions>> serviceType) {
        super(serviceType);
    }
